...
public class NormalizationHelper {
     ...
     *
     * <p>
     * Method: for each value in dataIn array is applied the follow rule:
     * <br> 1) value != 0, results in 1
     * <br> 2) value == 0, results in 0.
     *
     * <p>
     * If the dataOut is null, then the result is put in dataIn array. This mean that dataOut could
     * be the same as dataIn.
     *
     ...
     * <br>This normalization is used to bring all values into the range [0, 1]. This is also called
     * unity-based normalization.
     * <p>
     * The main formula is: N = (V - Vmin) / (Vmax - Vmin)
     *
