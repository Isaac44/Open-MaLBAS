...
public class MlpRun extends Mlp {
   ...
   *
   *    Demais metodos:
   *        computeOutput            - metodo identico ao implementado na classe "MlpTrain"
   *        createDir                - metodo implementado na classe base "Mlp"
   *        createLink
   *        createNeuron
   *        createPattern            - metodo identico ao implementado na classe "MlpTrain"
   *        fLogsig                  - metodo implementado na classe base "Mlp"
   *        fTansig                  - metodo implementado na classe base "Mlp"
   *        getPatternError          - metodo identico ao implementado na classe "MlpTrain"
   *        initBiasWeights
   *        initLink
   *        initNet
   *        initNeuron
   *        inputPattern             - metodo identico ao implementado na classe "MlpTrain"
   *        printArchPar             - metodo implementado na classe base "Mlp"
   *        printBiasWeights         - metodo identico ao implementado na classe "MlpTrain"
   *        printLink
   *        printNeuron
   ...
   */
   ...
   /**
   * Getters e Setters para executar diretamente a RN
   * getNeuActiv(int neuronNumber) - retorna o valor da ativacao do neuronio "neuronNumber".
   * getNumNeuFinInp() - retorna o numero do neuronio final na camada de entrada.
   * getNumNeuFinOut() - retorna o numero do neuronio final na camada de saida.
   * getNumNeuIniInp() - retorna o numero do neuronio inicial na camada de entrada.
   * getNumNeuIniOut() - retorna o numero do neuronio inicial na camada de saida.
   * getPattern(int neuronNumber) - retorna o valor de "pattern" relativo ao neuronio "neuronNumber".
   * setPattern(int neuronNumber, float value) - armazena "value" em "pattern", relativo aa "neuronNumber".
   */
   ...
   * A saida produzida pela rede sobre o padrao de teste "pattern" e' retornada
   * em:  "neuronio[niO].activation" ... "neuronio[nfO].activation".
   * @param - sem parametros.
   */
   ...
   /**
   * Executa padroes de teste, de forma supervisionada, na rede neural. A saida produzida
   * pela rede sobre cada um dos padroes e' comparada com a saida esperada, gerando um erro.
   * Os padroes de teste e seus respectivos erros sao impressos em um arquivo de "log".
   * @param testFileName - nome do arquivo de onde os padroes de teste serao lidos.
   */
