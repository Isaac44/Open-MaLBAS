...
public class MlpTrain extends Mlp {
     ...
     * Construtor: MlpTrain
     *
     * Demais metodos: changeBiasWeights changeRates computeBedWed
     * computeDbiasDweights computeError computeIncBedWed computeOutput - metodo
     * identico ao implementado na classe "MlpRun" copyFile createDir - metodo
     * implementado na classe base "Mlp" createLink createNeuron createPattern -
     * metodo identico ao implementado na classe "MlpRun" createTpattern
     * deleteFile fLogsig - metodo implementado na classe base "Mlp" fTansig -
     * metodo implementado na classe base "Mlp" genBiasWeights getPatternError -
     * metodo identico ao implementado na classe "MlpRun" getTpatternError
     * initLink initNet initNeuron inputPattern - metodo identico ao
     * implementado na classe "MlpRun" inputTpattern printArchPar - metodo
     * implementado na classe base "Mlp" printBiasWeights - metodo identico ao
     * implementado na classe "MlpRun" printLink printNeuron printTpattern
     * readArchPar - metodo implementado na classe base "Mlp" readTpattern
     * resetBedWed resetNetinputActivation runValSup trainByEpoch trainByPattern
     */
    /**
     * Construtor
     *
     ...
     * @param trainFileName - nome do arquivo de onde os padroes de treinamento
     * serao lidos.
     */
     ...
     *
     * @param fileName - nome do arquivo de onde os padroes de treinamento serao
     * lidos.
     */
    ...
    /**
     * Executa padroes de validacao, de forma supervisionada, na rede neural. A
     * saida produzida pela rede sobre cada um dos padroes e' comparada com a
     * saida esperada, gerando um erro. O erro total sobre os padroes de
     * validacao e' retornado.
     *
