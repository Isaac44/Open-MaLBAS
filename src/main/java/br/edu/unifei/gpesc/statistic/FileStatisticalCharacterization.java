 ...
 * @author isaac
 */
public class FileStatisticalCharacterization extends StatisticalCharacterization<String> {

    /**
     *
     * @param statisticalVector
     */
    public FileStatisticalCharacterization(StatisticalCharacteristic<String> statisticalVector) {
